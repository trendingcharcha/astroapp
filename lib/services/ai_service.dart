...
class AIService {
  ...
  static Future<String> generateDailyTask({
    ...
    1. Vedic Quest: A simple mantra, prayer, or ritual suited for the goal.
    ...
    final Map<String, List<String>> offlineQuests = {
      'job': [
        "Vedic: Chant 'Om Suryaya Namah' 108 times facing East to invite career recognition.",
      ...
      'debt': [
        "Vedic: Recite the Rinmochan Mangal Stotra to dissolve debt energies.",
      ...
      'marriage': [
        "Vedic: Recite 'Om Katyayanyai Namah' (if single) or 'Om Namah Shivaya' 108 times.",
      ...
      'baby': [
        "Vedic: Recite the Santan Gopal Mantra together each morning for progeny blessings.",
      ...
      'business': [
        "Vedic: Perform a simple Ganesh Puja and chant 'Om Gan Ganapataye Namah' 21 times.",
      ...
      'property': [
        "Vedic: Chant 'Om Bhaumaya Namah' 108 times on Tuesday to invoke Mars energy.",
      ...
      'health': [
        "Vedic: Chant the Maha Mrityunjaya Mantra 11 times for healing solar energy.",
      ...
      'custom': [
        "Vedic: Light a ghee lamp at your home temple and pray for resolution.",
