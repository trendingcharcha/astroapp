...
pattern = r'// 5\. EVENT-ALIGNED VEDIC FASTING & HABIT DISCIPLINE[\s\S]*?return tasks;'
...
replacement = """// 5. EVENT-ALIGNED VEDIC FASTING & HABIT DISCIPLINE (Only for true events!)
      if (dayNum % 15 === 11) {
        ...
        tasks.push({
          ...
          xp: 20,
          color: '#5dade2',
          icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><polygon points="12 6 12 12 16 14"/></svg>'
        });
        ...
        tasks.push({
          ...
          xp: 20,
          color: '#8e44ad',
          icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 2v20M7 4v6a5 5 0 0 0 10 0V4M7 4L4 7M17 4l3 3M12 2l-3 3M12 2l3 3"/></svg>'
        });
      } else {
...
with open('index.html', 'w', encoding='utf-8') as f:
    f.write(content)
print("SUCCESSFULLY RESTORED ROADMAP TASK PUSHES!")
