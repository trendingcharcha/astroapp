...
target = """      // 5. EKADASHI FAST & LUNAR FASTING DISCIPLINE (Always present in Day-to-Day Tasks)
      if (dayNum % 15 === 11) {
        tasks.push({
          category: 'vedic',
        ...
        tasks.push({
          category: 'vedic',
          title: isHi ? `एकादशी व्रत अनुशासन एवं सात्विक आहार` : `Ekadashi Fast Discipline & Sattvic Habit`,
          timeWindow: 'Daily Fasting Discipline',
          text: isHi
            ? `वैदिक कोच की सलाह अनुसार: आगामी एकादशी व्रत की तैयारी के लिए आज सात्विक आहार लें, अत्यधिक नमक व तेल से बचें और पवित्र ऊर्जा बनाए रखें।`
            : `As advised in your Coach advice: Maintain a clean sattvic diet today, avoiding excess salt/heavy oils, to keep your karmic energy pure for Ekadashi fasting.`,
          xp: 15,
          color: 'var(--gold)',
          icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#E8C879" stroke-width="1.8"><path d="M12 2v2M4.93 4.93l1.41 1.41M20 12h2M17.66 17.66l1.41 1.41M2 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/><circle cx="12" cy="12" r="5" fill="none"/></svg>'
        });
...
replacement = """      // 5. EVENT-ALIGNED VEDIC FASTING & HABIT DISCIPLINE (Only for true events!)
      if (dayNum % 15 === 11) {
        tasks.push({
          category: 'vedic',
          title: isHi ? `पवित्र एकादशी पूर्ण व्रत (11वीं तिथि)` : `Sacred Ekadashi Full Vrat Fast (11th Tithi)`,
...
if target in content:
    ...
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(content)
    print("SUCCESSFULLY REPLACED EKADASHI DUMMY FALLBACK WITH EVENT-ALIGNED DISCIPLINE!")
else:
    print("ERROR: Target text not found in index.html")
